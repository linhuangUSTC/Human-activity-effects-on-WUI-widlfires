...
# - 各年份投影后WUI：Time_series_年份_Interface_WUI_equal_area
# - 各年份空间连接结果：Fishnet_SpatialJoin_WUI_年份
# - 各年份有效栅格：Grid_Clip_年份_interafce_WUI
# *************************************************************************************
# -------------------------------------------------------------------------------------
...
for year in years:
    ...
    final_output = os.path.join(output_gdb, "Grid_Clip_{0}_interafce_WUI".format(year))  # 最终有效栅格GDB要素类
