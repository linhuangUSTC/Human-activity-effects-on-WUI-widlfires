# -*- coding: utf-8 -*-
"""
程序名称：分类数据文件重组工具（Level 1分类版带WUI偏移量） (copy_category_files_S4_level1_with_WUI_offset.py)
...
输入路径：
    - Excel文件:I:\Processing data\渔网分类建模\火灾分类数据汇总\分类建模火灾数据汇总统计_level1_with_zero.xlsx
    - 源目录模式:I:\Processing data\渔网分类建模\{}
      ({}会被替换为年份,如2005、2010、2015、2020)

输出路径：
    - 目标目录:I:\Processing data\渔网分类建模\Fire_num_with_WUI_area_offset_conclude_0_分类建模数据_Level_1
...
def process_category_data(excel_file, sheet_name, output_suffix):
    ...
    target_dir = "I:\Processing data\渔网分类建模\Fire_num_with_WUI_area_offset_conclude_0_分类建模数据_Level_1"  # 修改为Level 1带WUI偏移量输出目录
...
def main():
    ...
    excel_file = "I:\Processing data\渔网分类建模\火灾分类数据汇总\分类建模火灾数据汇总统计_level1_with_zero.xlsx"
