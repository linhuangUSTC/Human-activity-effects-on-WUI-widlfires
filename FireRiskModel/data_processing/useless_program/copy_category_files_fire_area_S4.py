# -*- coding: utf-8 -*-
"""
程序名称：分类数据文件重组工具 (copy_category_files_S4.py)
...
输入路径：
    - Excel文件：I:\Processing data\渔网分类建模\火灾分类数据汇总\分类建模火灾数据汇总统计.xlsx
...
输出路径：
    - 目标目录：I:\Processing data\渔网分类建模\Fire_area_with_WUI_area_offset_without_0_分类建模数据
...
def process_category_data(excel_file, sheet_name, output_suffix, filter_column, filter_value=0):
    ...
    filter_column: 过滤条件的列名
    filter_value: 过滤条件的值（默认0）
    """
    # 配置参数
    category_id_column = "分类ID"
    years = [2005, 2010, 2015, 2020]
    source_dir_pattern = r"I:\Processing data\渔网分类建模\{}"
    target_dir = r"I:\Processing data\渔网分类建模\Fire_area_with_WUI_area_offset_without_0_分类建模数据"
...
def main():
    # 配置参数
    excel_file = r"I:\Processing data\渔网分类建模\火灾分类数据汇总\分类建模火灾数据汇总统计.xlsx"
