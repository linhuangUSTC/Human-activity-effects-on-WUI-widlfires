...
输出:
    - B:\WUI\Picture\Grouped_Human Footprint_effect_by_{parameter}_interface_intermix_2003_2022_10groups_1x2_barplot.png
"""
...
def draw_metric_interface_intermix_bar_chart(
    ...
    ax.set_title(str(dataset["effect_label"]), fontsize=SUBPLOT_TITLE_FONT_SIZE, pad=10)
...
def plot_parameter_metrics_1x2(
    ...
    output_path = OUTPUT_DIR / (
        f"Grouped_Human Footprint_effect_by_{parameter_config['slug']}_interface_intermix_{YEAR_TAG}_{GROUP_TAG}_1x2_barplot.png"
    )
