...
# -*- coding: utf-8 -*-
r"""
程序名称: GDP 第 2 组与第 20 组对应 HFI 影响的全球与局部空间分布图

功能简介:
    1) 直接读取「将GDP_人口密度_道路密度分成20组_计算组内的HFI影响_柱状图.py」
       输出的 Grouped_Human Footprint_effect_2003_2022_group_summary.csv
    2) 读取 2005、2010、2015、2020 四个年份的 GDP 数据以及同年份 HFI 影响数据
    3) 将当年 GDP 落在第 2 组与第 20 组范围内的 WUI 格网筛出
    4) 全球图保持 GDP 分组的红/蓝栅格分布，并叠加 4 个局部放大范围框
    5) 局部图仅绘制这两组对应格网的 HFI 影响值，每个区域单独输出一张图
...
输出:
    ...
    - B:\WUI\Picture\Spatial_distribution_GDP_group02_group20_Human Footprint_effect_Fire_frequency_2005_A.png
    - B:\WUI\Picture\Spatial_distribution_GDP_group02_group20_Human Footprint_effect_Fire_frequency_2005_B.png
    - B:\WUI\Picture\Spatial_distribution_GDP_group02_group20_Human Footprint_effect_Fire_frequency_2005_C.png
    - B:\WUI\Picture\Spatial_distribution_GDP_group02_group20_Human Footprint_effect_Fire_frequency_2005_D.png
    - 其余年份与 Normalized burned area 同名模式输出
"""
...
DATASETS = [
    ...
    },
    {
        ...
        "effect_source": Path(r"B:\WUI\Picture and statistic results\HFI的净效应-固定效应结果\csv\Fire area"),
    },
]
    ...
    for dataset in DATASETS:
        ...
        for year in TARGET_YEARS:
            ...
            for region in REGIONS:
                local_output_path = (
                    OUTPUT_DIR
                    / f"Spatial_distribution_GDP_group02_group20_Human Footprint_effect_{dataset['output_slug']}_{year}_{region['label']}.png"
                )
